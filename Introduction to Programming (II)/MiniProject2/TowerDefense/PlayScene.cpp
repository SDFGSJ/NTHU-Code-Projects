...
void PlayScene::Terminate() {
	...
	IScene::Terminate();
	printf("after playscene terminate\n");
}
...
void PlayScene::OnMouseDown(int button, int mx, int my) {
	...
	printf("after playscene mousedown\n");
}
...
void PlayScene::OnMouseUp(int button, int mx, int my) {
	...
	printf("after playscene mouseup\n");
}
void PlayScene::OnKeyDown(int keyCode) {
	...
	printf("after playscene onkeydown\n");
}
void PlayScene::Hit() {
	if (lives<=0) {
		// Free resources.
...
void PlayScene::ReadMap() {
	...
	printf("after playscene readmap\n");
}
void PlayScene::ReadEnemyWave() {
	...
	fin.close();
	printf("after playscene readenemywave\n");
}
void PlayScene::ConstructUI() {
	...
	printf("after playscene constructUI\n");
}
...
void PlayScene::UIBtnClicked(int id) {
	...
	printf("after playscene UIbtnclicked\n");
}
...
bool PlayScene::CheckSpaceValid(int x, int y) {
	...
	return true;
	printf("after playscene checkvalid\n");
}
void PlayScene::freespace(float x,float y){
	const int mx = x / BlockSize;
	const int my = y / BlockSize;
	if(mapState[my][mx]==TILE_OCCUPIED){
		mapState[my][mx]=TILE_FLOOR;
	}
}
