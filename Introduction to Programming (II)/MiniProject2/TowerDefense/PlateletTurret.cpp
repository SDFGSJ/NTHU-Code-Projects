...
const int PlateletTurret::Price = 30;
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/turret-2.png", x, y, Price, 0.5, 20) {
...
void PlateletTurret::CreateBullet() {
	...
	getPlayScene()->EffectGroup->AddNewObject(new TurretShootEffect(Position.x+50,Position.y));
